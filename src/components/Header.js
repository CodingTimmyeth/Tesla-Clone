    ...
    return (
        <Container>
            <a href="https://www.google.com/">
                <img src="/Tesla-Images/logo.svg" alt="Tesla Logo" />
            </a>
            <Menu>
                {cars && cars.map((car, index) => (
                    <a key={index} href="https://www.google.com/">{car}</a>
            ...
            <BurgerNav show={burgerStatus}>
                ...
                {cars && cars.map((car, index) => (
                    <li key={index}>
                        <a href="https://www.google.com/">{car}</a>
                    </li>
                ))}
                <li>
                ...
                <li>
                    <a href="https://www.google.com/">Roadaster</a>
                </li>
                <li>
